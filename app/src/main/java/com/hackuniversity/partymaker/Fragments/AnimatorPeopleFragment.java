...
public class AnimatorPeopleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText("Аниматоры");
        RecyclerView recyclerView = viewRoot.findViewById(R.id.recyclerView_addPeopleOnEvent);
        RecyclerViewPeopleAdaper adapter = new RecyclerViewPeopleAdaper(AllPeopleLiveData.getInstance().getAnimatorPeople());
